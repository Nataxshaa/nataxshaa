...
<details>
<summary>📊 <b>hackathon-sindisei-df/</b> — dashboard inteligente com visão computacional</summary>
<br>

Hackathon promovido pelo **Sindisei DF**:
- Dashboard inteligente alimentado por dados extraídos automaticamente
- Modelo de visão computacional treinado com **YOLO** para gerar os dados de entrada

`stack:` YOLO · Visão Computacional · Dashboard
</details>
